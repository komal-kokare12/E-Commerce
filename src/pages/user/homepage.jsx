...
const HomePage = () => {
  ...
  const handleMouseEnter = () => {
    ...
    setTimeout(() => {
      blockAnimation.start({ scale: 1, transition: { duration: 0.5 } });
    }, 500);
  };
    ...
    <>
      ...
      <div className="w-full bg-white overflow-hidden">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          >
            <div className="bg-white/10 backdrop-blur-md border border-white/100 p-12 md:p-16 rounded-3xl shadow-2xl text-center">
              <h1 className="mb-6 text-4xl md:text-4xl font-extrabold text-pink tracking-tight bg-clip-text bg-gradient-to-r from-pink-500 to-blue-500 text-transparent">
                Crafting Memorable Moments
              </h1>
              <p className="mb-8 text-xl text-pink-800 max-w-2xl mx-auto">
              ...
              <div className="space-x-4 flex justify-center">
                <Link to="/about">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-pink-600 to-rose-500 text-white hover:opacity-90 px-10 py-3 rounded-full uppercase text-sm tracking-wider font-bold shadow-xl transition-all"
                  >
                    Explore Our Story
                  </motion.button>
                </Link>
        ...
        <section className="relative min-h-[80vh] flex items-center" data-aos="fade-up">
          ...
          <div className="container relative z-10 mx-auto max-w-6xl px-4">
            <motion.div
              className="bg-white/25 backdrop-blur-md border border-white/60 p-12 md:p-16 rounded-3xl max-w-2xl mx-auto text-center shadow-2xl"
            ...
            >
              ...
              <p className="text-xl text-pink-800 mb-10 leading-relaxed">
              ...
              <Link to="/about">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-pink-600 to-rose-500 text-white hover:opacity-90 px-12 py-4 rounded-full uppercase text-sm tracking-wider font-bold shadow-xl transition-all"
                >
                  Our Journey
                </motion.button>
              </Link>
